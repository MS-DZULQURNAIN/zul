    ...
    if msg.reply_to_message:
        ...
        if not is_animated:
            try:
                ...
                elif e.message == "Emoji stiker tidak valid":
                    msg.reply_text("Invalid emoji(s).")
                elif e.message == "Stickers_too_much":
                    msg.reply_text("Ukuran paket maksimal tercapai. Tekan F untuk memberi hormat.")
                elif e.message == "Kesalahan Server Internal: set stiker tidak ditemukan (500)":
                    edited_keyboard = InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton(
        ...
        packs_text = "*Tolong balas stiker, atau gambar untuk kang!*\n"
        if packnum > 0:
        ...
        edited_keyboard = InlineKeyboardMarkup(
            [[InlineKeyboardButton(text="Lihat Paket", url=f"{packs}")]]
        )
        msg.reply_text(
...
def makepack_internal(
    ...
    keyboard = InlineKeyboardMarkup(
        [[InlineKeyboardButton(text="Lihat Paket", url=f"{packname}")]]
    )
    try:
        extra_version = ""
        if packnum > 0:
        ...
        print(e)
        if e.message == "Nama kumpulan stiker sudah terisi":
            msg.reply_text(
                ...
                "\n\n<b>Kirim /stickers untuk menemukan paket stiker apa pun.</b>",
                reply_markup=keyboard,
                parse_mode=ParseMode.HTML,
            )
        elif e.message == "Peer_id_invalid" or "bot diblokir oleh pengguna":
            msg.reply_text(
                f"{context.bot.first_name} diblokir oleh Anda.",
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                text="Buka blokir", url=f"t.me/{context.bot.username}"
                            )
                        ]
                    ]
                ),
            ...
            msg.reply_text(
                ...
                "\n\nAnda sekarang dapat membalas gambar, stiker, dan stiker animasi dengan /steal untuk menambahkannya ke paket Anda"
                "\n\n<b>Kirim /stickers untuk menemukan paket stiker.</b>",
                reply_markup=keyboard,
                parse_mode=ParseMode.HTML,
            )
        return
...
ᐉ /stickerid*:* balas stiker ke saya untuk memberi tahu Anda ID file-nya.
ᐉ /getsticker*:* balas stiker kepada saya untuk mengunggah file PNG mentahnya.
ᐉ /kang*:* balas stiker untuk menambahkannya ke paket Anda.
ᐉ /delsticker*:* Balas stiker anime Anda ke paket Anda untuk menghapusnya.
ᐉ /stickers*:* Temukan stiker untuk istilah tertentu di katalog stiker kombo
ᐉ /tiny*:* Untuk membuat stiker kecil
ᐉ /kamuii <1-8> *:* Untuk memperdalam stiker
ᐉ /mmf <reply with text>*:* Untuk menggambar teks untuk stiker atau pohots
"""
