...
import Kynan.modules.sql.blacklist_sql as sql
from Kynan import dispatcher, LOGGER
from Kynan.modules.disable import DisableAbleCommandHandler
from Kynan.modules.helper_funcs.chat_status import user_admin, user_not_admin
from Kynan.modules.helper_funcs.extraction import extract_text
from Kynan.modules.helper_funcs.misc import split_message
from Kynan.modules.log_channel import loggable
from Kynan.modules.warns import warn
from Kynan.modules.helper_funcs.string_handling import extract_time
from Kynan.modules.connection import connected
from Kynan.modules.sql.approve_sql import is_approved
from Kynan.modules.helper_funcs.alternate import send_message, typing_action
...
ᐉ /blacklist*:* Lihat kata-kata yang masuk daftar hitam saat ini.

➣ Admin only:
ᐉ /addblacklist <pemicu>*:* Tambahkan pemicu ke daftar hitam. Setiap baris dianggap sebagai satu pemicu, jadi menggunakan baris yang berbeda akan memungkinkan Anda untuk menambahkan beberapa pemicu.
ᐉ /unblacklist <pemicu>*:* Hapus pemicu dari daftar hitam. Logika baris baru yang sama berlaku di sini, sehingga Anda dapat menghapus beberapa pemicu sekaligus.
ᐉ /blacklistmode <off/del/warn/ban/kick/mute/tban/tmute>*:* Tindakan yang harus dilakukan ketika seseorang mengirim kata-kata yang masuk daftar hitam.
...
ᐉ • /blsticker*:* Lihat stiker daftar hitam saat ini
*Only admin:*
ᐉ /addblsticker <sticker link>*:* Tambahkan pemicu stiker ke daftar hitam. Dapat ditambahkan melalui stiker balasan
ᐉ /unblsticker <sticker link>*:* Hapus pemicu dari daftar hitam. Logika baris baru yang sama berlaku di sini, sehingga Anda dapat menghapus beberapa pemicu sekaligus
ᐉ /rmblsticker <sticker link>*:* Sama seperti di atas
ᐉ /blstickermode <delete/ban/tban/mute/tmute>*:* menyiapkan tindakan default tentang apa yang harus dilakukan jika pengguna menggunakan stiker yang masuk daftar hitam
Note:
ᐉ <sticker link> dapat `https://t.me/addstickers/<sticker>` atau hanya `<sticker>` atau balas pesan stiker
