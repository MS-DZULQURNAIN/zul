...
from Kynan.modules.helper_funcs.handlers import CMD_STARTERS, SpamChecker
from Kynan.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from Kynan.modules.sql import disable_sql as sql
    ...
    def disable_module(update: Update, context: CallbackContext):
        ...
        chat = update.effective_chat
        if len(args) >= 1:
            disable_module = "Kynan.modules." + args[0].rsplit(".", 1)[0]
    ...
    def enable_module(update: Update, context: CallbackContext):
        ...
        if len(args) >= 1:
            enable_module = "Kynan.modules." + args[0].rsplit(".", 1)[0]
    ...
    __help__ = """
ᐉ /cmds*:* periksa status perintah yang dinonaktifkan saat ini
➣ *Hanya admin:*
ᐉ /enable <nama perintah>*:* aktifkan perintah itu
ᐉ /disable <nama perintah>*:* nonaktifkan perintah itu
ᐉ /enablemodule <module name>*:* aktifkan semua perintah dalam modul itu
ᐉ /disablemodule <module name>*:* nonaktifkan semua perintah dalam modul itu
ᐉ /listcmds*:* daftar semua kemungkinan perintah yang dapat dialihkan
"""
