...
from Kynan.modules.sql import afk_sql as sql
from Kynan.modules.users import get_user_id
...
def afk(update: Update, context: CallbackContext):
    ...
    try:
        update.effective_message.reply_text("{} sekarang pergi menghilang...{}".format(fname, notice))
    except BadRequest:
        pass
    ...
    if res:
        ...
        try:
            options = [
                "{} dia disini!",
                "{} dia kembali!",
                "{} dia sekarang ada di chat!",
                "{} udah bangun!",
                "{} kembali online!",
                "{} akhirnya disini!",
                "Selamat Datang kembali! {}",
                "Siapakah dia?{}?\ndia sudah kembali ke chat!",
            ]
...
ᐉ /afk <alasan>*:* Tandai diri Anda sebagai AFK.
  - brb <alasan>: Sama seperti perintah afk, tapi bukan perintah. 
  """
