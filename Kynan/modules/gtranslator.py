...
from Kynan import dispatcher, pbot
...
➣ *Perintah:*
ᐉ /tl (atau /tr): sebagai balasan pesan, terjemahkan ke bahasa Inggris.
ᐉ /tl <lang>: diterjemahkan menjadi <lang>
misalnya: /tl ja: diterjemahkan ke dalam bahasa Jepang.
ᐉ /tl <source>//<dest>: diterjemahkan dari <source> ke <lang>.
misalnya:  /tl ja//en: menerjemahkan dari bahasa Jepang ke bahasa Inggris.
ᐉ /langs: dapatkan daftar bahasa yang didukung untuk terjemahan.
Saya dapat mengubah teks menjadi suara dan suara menjadi teks..
ᐉ /tts <lang code>*:* Balas pesan apa pun untuk mendapatkan output teks ke ucapan
ᐉ /stt*:* Ketik membalas pesan suara (hanya mendukung bahasa Inggris) untuk mengekstrak teks darinya.
➣ *Kode bahasa*
