...
import Kynan.modules.sql.global_bans_sql as sql
from Kynan.modules.sql.users_sql import get_user_com_chats
from Kynan import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from Kynan.modules.helper_funcs.misc import send_to_list
...
__help__ = f"""
➣ *Hanya admin:*
ᐉ `/antispam <on/off/yes/no>`*:* Akan mengaktifkan teknologi antispam kami atau mengembalikan pengaturan Anda saat ini.
