...
from Kynan import ALLOW_EXCL, CustomCommandHandler, dispatcher
...
from Kynan.modules.sql import cleaner_sql as sql
...
ᐉ • /cleanblue <on/off/yes/no>*:* bersihkan perintah setelah mengirim
ᐉ • /ignoreblue <kata>*:* mencegah pembersihan otomatis dari perintah
ᐉ • /unignoreblue <kata>*:* hapus cegah pembersihan otomatis dari perintah
ᐉ • /listblue*:* daftar perintah yang saat ini masuk daftar putih

➣ *Berikut ini adalah perintah khusus Bencana, admin tidak dapat menggunakan ini:*

ᐉ • /gignoreblue <kata>*:* secara global mengabaikan pembersihan teks biru dari kata yang disimpan di seluruh Hikari.
ᐉ • /ungignoreblue <kata>*:* hapus perintah tersebut dari daftar pembersihan global
"""
