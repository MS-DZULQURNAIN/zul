...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        await event.reply("Balas pesan suara, untuk mengeluarkan teks darinya.")

__mod_name__ = "Voice"

__help__ = """
➣ *Voice.*
ᐉ /stt*:* Pesan Suara Ke Teks (Akurasi Belum Tentu 100% ).
ᐉ /tts *:* Teks Ke Pesan Suara Oleh Google.
