...
from Kynan import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Kynan.__main__ import DATA_IMPORT
from Kynan.modules.helper_funcs.chat_status import user_admin
from Kynan.modules.helper_funcs.alternate import typing_action

# from Kynan.modules.rules import get_rules
import Kynan.modules.sql.rules_sql as rulessql

# from Kynan.modules.sql import warns_sql as warnssql
import Kynan.modules.sql.blacklist_sql as blacklistsql
from Kynan.modules.sql import disable_sql as disabledsql

# from Kynan.modules.sql import cust_filters_sql as filtersql
# import Kynan.modules.sql.welcome_sql as welcsql
import Kynan.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    with open("Kynan{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Kynan{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Kynan-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("Kynan{}.backup".format(chat_id))  # Cleaning file
