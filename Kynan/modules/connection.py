...
import Kynan.modules.sql.connection_sql as sql
from Kynan import dispatcher, DRAGONS, DEV_USERS
from Kynan.modules.helper_funcs import chat_status
...
def connection_chat(update, context):
    ...
    if conn:
        ...
        message = "Saat ini Anda tidak terhubung ke grup mana pun.\n"
...
__help__ = """
➣ Kadang-kadang, Anda hanya ingin menambahkan beberapa catatan dan filter ke obrolan grup, tetapi Anda tidak ingin semua orang melihatnya; Di sinilah koneksi masuk...
Ini memungkinkan Anda untuk terhubung ke database obrolan, dan tambahkan sesuatu ke dalamnya tanpa perintah yang muncul di obrolan! Untuk alasan yang jelas, Anda harus menjadi admin untuk menambahkan sesuatu; tetapi setiap anggota dalam grup dapat melihat data Anda.
ᐉ /connect: Terhubung ke obrolan (Dapat dilakukan dalam grup dengan /connect atau /connect <id obrolan> di PM)
ᐉ /connection: Daftar obrolan yang terhubung
ᐉ /disconnect: Putuskan sambungan dari obrolan
ᐉ /helpconnect: Daftar perintah yang tersedia yang dapat digunakan dari jarak jauh
➣ *Hanya admin:*
ᐉ /allowconnect <yes/no>: izinkan pengguna terhubung ke obrolan
"""
