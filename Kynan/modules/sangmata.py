...
from Kynan import ubot2 as ubot
...
async def lastname(steal):
    ...
    puki = await steal.reply("`Gua Kepo Siapa Sih Nama Lu`")
    if steal.fwd_from:
        return
    ...
    try:
        ...
        return await puki.edit("`Dia Terlalu Jamet Maaf`")
        
__mod_name__ = "Sangmata"

__help__ = """
➣ *Perintah Tersedia.*
ᐉ /sg *:* Untuk Melihat Histori Nama Seseorang.
