...
from Kynan.ex_plugins.dbfunctions import get_couple, save_couple
...
async def couple(_, message):
    if message.chat.type == "private":
        await message.reply_text("Perintah ini hanya bekerja dalam grup.")
        return
    try:
...
__Pasangan baru hari ini dapat dipilih pada pukul 12 pagi {tomorrow}__"""
...
__help__ = """
➣ *Couple.*
ᐉ /couple*:* Untuk Melihat Pasangan Hari ini .
