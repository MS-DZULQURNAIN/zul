...
if is_module_loaded(FILENAME):
    ...
    from Kynan.modules.sql import log_channel_sql as sql
    ...
    __help__ = """
➣ *Log channel. *
ᐉ /logchannel*:* dapatkan info saluran log
ᐉ /setlog*:* mengatur saluran log.
ᐉ /unsetlog*:* hapus saluran log.
*Pengaturan saluran log dilakukan dengan*:
ᐉ menambahkan bot ke saluran yang diinginkan (sebagai admin!)
ᐉ mengirim /setlog di saluran
ᐉ meneruskan /setlog ke grup
"""
