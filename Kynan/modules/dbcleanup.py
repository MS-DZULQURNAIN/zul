...
import Kynan.modules.sql.global_bans_sql as gban_sql
import Kynan.modules.sql.users_sql as user_sql
from Kynan import (
  DEV_USERS,
  OWNER_ID,
  dispatcher,
...
def dbcleanup(update: Update, context: CallbackContext):
    ...
    reply = f"Total obrolan tidak valid - {invalid_chat_count}\n"
    reply += f"Total pengguna yang diblokir tidak valid - {invalid_gban_count}"
