...
import telegram
from Kynan import TIGERS, WOLVES, dispatcher
from Kynan.modules.disable import DisableAbleCommandHandler
from Kynan.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from Kynan.modules.helper_funcs.string_handling import split_quotes
from Kynan.modules.log_channel import loggable
from Kynan.modules.sql import warns_sql as sql
...
__help__ = """
➣ *Warn.*
ᐉ /warns <pegangan pengguna>: dapatkan nomor pengguna, dan alasan, dari peringatan.
ᐉ /warnlist: daftar semua filter peringatan saat ini
ᐉ /warn <userhandle>: memperingatkan pengguna. Setelah 3 kali peringatan, pengguna akan diblokir dari grup. Bisa juga digunakan sebagai balasan.
ᐉ /dwarn <userhandle>: memperingatkan pengguna dan menghapus pesan. Setelah 3 kali peringatan, pengguna akan diblokir dari grup. Bisa juga digunakan sebagai balasan.
ᐉ /resetwarn <userhandle>: mengatur ulang peringatan untuk pengguna. Bisa juga digunakan sebagai balasan.
ᐉ /addwarn <keyword> <reply message>: atur filter peringatan pada kata kunci tertentu. Jika Anda ingin kata kunci Anda menjadi sebuah kalimat, sertakan dengan tanda kutip, seperti itu: /addwarn "sangat marah" Ini adalah pengguna yang marah.
ᐉ /nowarn <keyword>: hentikan filter peringatan
ᐉ /warnlimit <num>: atur batas peringatan
ᐉ /strongwarn <on/yes/off/no>: Jika disetel ke aktif, melebihi batas peringatan akan mengakibatkan larangan. Lain, hanya akan meninju.
"""
