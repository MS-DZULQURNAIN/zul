...
from Kynan import LOGGER, DRAGONS, TIGERS, WOLVES, dispatcher
...
from Kynan.modules.sql import reporting_sql as sql
    ...
    if chat and message.reply_to_message and sql.chat_should_report(chat.id):
        ...
        if chat.username and chat.type == Chat.SUPERGROUP:
            ...
            msg = (
                ...
                f"<b> • Laporan pengguna:</b> {mention_html(reported_user.id, reported_user.first_name)} (<code>{reported_user.id}</code>)\n"
            )
...
def buttons(update: Update, context: CallbackContext):
    ...
    if splitter[1] == "kick":
        try:
            ...
            query.aswer("✅ Berhasil menendang")
            return ""
...
__help__ = """
➣ *Report.*
ᐉ /report <Alasan>*:* membalas pesan untuk melaporkannya ke admin.
ᐉ @admin*:* balas pesan untuk melaporkannya ke admin.
➣ *CATATAN:* Tak satu pun dari ini akan dipicu jika digunakan oleh admin.
*Hanya Admin :*
ᐉ /reports <on/off>*:* mengubah pengaturan laporan, atau melihat status saat ini.
ᐉ Jika selesai, matikan status Anda.
ᐉ Jika dalam grup, matikan status grup tersebut.
"""
