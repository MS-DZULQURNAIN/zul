...
from Kynan.modules.helper_funcs.extraction import extract_user_and_text
from Kynan.modules.helper_funcs.string_handling import extract_time
from Kynan.modules.log_channel import gloggable, loggable
...
__help__ = """
➣ *User Commands:*
ᐉ /kickme*:* menendang pengguna yang mengeluarkan perintah
➣ *Admins only:*
ᐉ /ban <userhandle>*:* melarang pengguna. (melalui pegangan, atau balas)
ᐉ /sban <userhandle>*:* Diam-diam melarang pengguna. Hapus perintah, Membalas pesan dan tidak membalas. (via handle, or reply)
ᐉ /tban <userhandle> x(m/h/d)*:* melarang pengguna untuk x waktu. (via handle, or reply). m = menit, h = jam, d = hari.
ᐉ /unban <userhandle>*:* membatalkan pemblokiran pengguna. (via handle, or reply)
ᐉ /kick <userhandle>*:* mengeluarkan pengguna dari grup, (via handle, or reply)
ᐉ /mute <userhandle>*:* membungkam pengguna. Dapat juga digunakan sebagai balasan, menonaktifkan balasan ke pengguna.
ᐉ /tmute <userhandle> x(m/h/d)*:* membisukan pengguna selama x waktu. (via handle, or reply). m = menit, h = jam, d = hari.
ᐉ /unmute <userhandle>*:* membunyikan pengguna. Dapat juga digunakan sebagai balasan, menonaktifkan balasan ke pengguna.
ᐉ /zombies*:* mencari akun terhapus
ᐉ /zombies clean*:* menghapus akun terhapus dari grup.
ᐉ /snipe <chatid> <string>*:* Buat saya mengirim pesan ke obrolan tertentu.
"""
