...
from Kynan.__main__ import STATS, TOKEN, USER_INFO
from Kynan.modules.sql import SESSION
import Kynan.modules.sql.userinfo_sql as sql
from Kynan.modules.disable import DisableAbleCommandHandler
from Kynan.modules.sql.global_bans_sql import is_user_gbanned
from Kynan.modules.sql.afk_sql import is_afk, set_afk
from Kynan.modules.sql.users_sql import get_user_num_chats
from Kynan.modules.helper_funcs.chat_status import sudo_plus
from Kynan.modules.helper_funcs.extraction import extract_user
...
def info(update: Update, context: CallbackContext):
    ...
    if user_id:
        ...
        message.reply_text("Saya tidak dapat mengekstrak pengguna.")
        return

    else:
        return

    rep = message.reply_text("<code>Mencari🔎...</code>", parse_mode=ParseMode.HTML)
    ...
    if user.id == OWNER_ID:
        ...
        disaster_level_present = True
         ...
         text += "\n\nOwner Of A Bot. King Of @excute7 . "
         disaster_level_present = True
            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ᴅᴏɴᴀsɪ ​❤️", url="https://telegra.ph/file/67d31a4224e3e0211448a.jpg"),
                            InlineKeyboardButton(
                                "ᴏᴡɴᴇʀ", url="https://t.me/kiritonibos"),
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def stats(update: Update, context: CallbackContext):
    stats = "🤖 <b>Stats For <a href='https://t.me/rito_robot'> ͔ ꝛɪᴛσ ꝛᴏʙᴏᴛ˼༗ </a>:</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
...
def about_bio(update: Update, context: CallbackContext):
    ...
    if info:
        ...
        update.effective_message.reply_text(
            f"{username} belum memiliki bio mereka sendiri!\nSetel pesan menggunakan /setbio",
        )
    else:
        update.effective_message.reply_text(
...
__help__ = """
➣ *ID:*
ᐉ /id*:* dapatkan id grup saat ini. Jika digunakan dengan membalas pesan, dapatkan id pengguna itu.
ᐉ /gifid*:* balas gif kepada saya untuk memberi tahu Anda ID filenya.
 
➣ *Informasi tambahan sendiri:* 
ᐉ /setme <text>*:* akan mengatur info Anda
ᐉ /me*:* akan mendapatkan info Anda atau pengguna lain.
Contoh:
ᐉ /setme saya serigala.
...
ᐉ /setbio Pengguna ini adalah serigala (membalas pengguna)
 
➣ *Overall Information about you:*
ᐉ /info*:* mendapatkan informasi tentang pengguna. 
 
➣ *Json Detailed info:*
ᐉ /json*:* Dapatkan info detail tentang pesan apa pun.
 
➣ *What is that health thingy?*
 Datang dan lihat [Sistem HP menjelaskan](https://t.me/KennedyProject/44)
"""
