...
*╰ ɢʀᴏᴜᴘꜱ ᐉ* `{}`
╼┅━━━━━━━━━━╍━━━━━━┅╾
* sᴀʏᴀ ᴀᴅᴀʟᴀʜ ʙᴏᴛ ɢʀᴏᴜᴘ ʜᴇʟᴘ*
* ᴜɴᴛᴜᴋ ᴍᴇɴɢᴀᴛᴜʀ ᴋᴇᴘᴇʀʟᴜᴀɴ ɢʀᴜᴘ*
* sᴀʏᴀ ᴊᴜɢᴀ ᴅᴀᴘᴀᴛ ᴍᴇᴍᴜᴛᴀʀ ᴍᴜsɪᴄ*
* ᴅɪ ɢʀᴜᴘ ᴀᴛᴀᴜ ᴄʜᴀɴɴᴇʟ ᴀɴᴅᴀ .*
╼┅━━━━━━━━━━╍━━━━━━┅╾
"""
...
def kynan_about_callback(update, context):
    ...
    if query.data == "kynan_":
        ...
        query.message.edit_text(
            ...
            "\n\n 🚀 𝙐𝙎𝙀𝙍𝘽𝙊𝙏 𝙂𝘾𝘼𝙎𝙏"
            "\n      ├ ʀᴘ. 20.000  [ ʙᴜʟᴀɴᴀɴ ᴜsᴇʀʙᴏᴛ ]"
            "\n      └ sɪsᴛᴇᴍ ᴛᴇʀɪᴍᴀ ᴊᴀᴅɪ"
            "\n\n 🚀 𝘽𝙊𝙏 𝙈𝙐𝙎𝙄𝙆"
            "\n      ├ ʀᴘ. 80.000 [ ᴠᴘs/1ʙᴜʟᴀɴ ]"
            "\n      ├ ᴀᴡᴀʟᴀɴ ᴘᴀsᴀɴɢ"
            "\n      └ sɪsᴛᴇᴍ ᴛᴇʀɪᴍᴀ ᴊᴀᴅɪ"
            "\n\n 🚀 𝘽𝙊𝙏 𝙈𝙐𝙎𝙄𝙆 & 𝙈𝘼𝙉𝘼𝙂𝙀"
            "\n      ├ ʀᴘ. 10.000  [ ᴄʟᴏɴᴇ ɢʜ ]"
        ...
        query.message.edit_text(
            text="𝙅𝙖𝙨𝙖 𝙏𝙚𝙡𝙚𝙜𝙧𝙖𝙢 𝙋𝙧𝙚𝙢𝙞𝙪𝙢"
            "\n\n 𝗟𝗶𝘀𝘁 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺 𝗣𝗿𝗲𝗺𝗶𝘂𝗺"
            "\n      ⊙ 𝟣 ʙᴜʟᴀɴ ᴠɪᴀ ʟᴏɢɪɴ » Rp.60.000,00"
            "\n      ⊙ 3 ʙᴜʟᴀɴ ᴠɪᴀ ɢɪғᴛ » Rp.200.000,00"
            "\n      ⊙ 𝟼 ʙᴜʟᴀɴ ᴠɪᴀ ɢɪғᴛ » Rp.250.000,00"
            "\n      ⊙𝟷𝟸 ʙᴜʟᴀɴ ᴠɪᴀ ɢɪғᴛ » Rp.500.000,00"
            "\n\n 𝗙𝗶𝘁𝘂𝗿 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺 𝗣𝗿𝗲𝗺𝗶𝘂𝗺 "
            "\n      ⊙ ꜰᴀsᴛ ᴅᴏᴡɴʟᴏᴀᴅ"
            "\n      ⊙ sᴛᴀᴛᴜs ᴇᴍᴏᴊɪ ᴅɪɴᴀᴍᴀ"
            "\n      ⊙ ᴄᴇᴘᴀᴛ ʙᴇʙᴀs ᴅᴀʀɪ ʟɪᴍɪᴛ"
            "\n      ⊙ ᴘʀᴏꜰɪʟ ᴠɪᴅᴇᴏ ʙᴇʀᴀɴɪᴍᴀsɪ"
            "\n      ⊙ ᴠᴏɪᴄᴇ ɴᴏᴛᴇ ᴄᴏɴᴠᴇʀᴛ ᴛᴇxᴛ"
            "\n      ⊙ sᴛɪᴄᴋᴇʀ ᴘʀᴇᴍɪᴜᴍ / ᴘɪᴄᴛᴜʀᴇ"
            "\n      ⊙ ʙɪsᴀ ʟᴏɢɪɴ 4 sᴇsɪ ᴅᴀʟᴀᴍ ᴀᴘᴋ"
            "\n\n 𝙋𝙧𝙤𝙨𝙚𝙨 𝙊𝙧𝙙𝙚𝙧 𝙏𝙚𝙡𝙚𝙜𝙧𝙖𝙢 𝙋𝙧𝙚𝙢𝙞𝙪𝙢"
            "\n      ⊙ ᴠɪᴀ ʟᴏɢɪɴ ᴘʀᴏsᴇs 5 - 15 ᴍᴇɴɪᴛ"
            "\n      ⊙ ᴘʀᴏsᴇs sᴇʟᴇsᴀɪ ᴋᴀᴍɪ ʟᴏɢ ᴏᴜᴛ"
            "\n      ⊙ ᴘʀɪᴠᴀsɪ ᴀᴍᴀɴ 100%"
            "\n\n 𝙉𝙤𝙩𝙚 : 𝙐𝙣𝙩𝙪𝙠 𝙈𝙚𝙣𝙜𝙚𝙩𝙖𝙝𝙪𝙞 𝙁𝙞𝙩𝙪𝙧"
            "\n      𝙇𝙚𝙣𝙜𝙠𝙖𝙥 𝙏𝙚𝙡𝙚𝙜𝙧𝙖𝙢 𝙋𝙧𝙚𝙢𝙞𝙪𝙢"
            "\n      𝘽𝙞𝙨𝙖 𝙇𝙞𝙝𝙖𝙩 𝙆𝙚 @Premium"
            "\n\n   𝗦𝗘𝗞𝗜𝗔𝗡 𝗧𝗘𝗥𝗜𝗠𝗔 𝗞𝗔𝗦𝗜𝗛 🙏.",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                 [
                  [
                    InlineKeyboardButton(text="️ᴋʏɴᴀɴ", url="https://t.me/kenapanan"),
