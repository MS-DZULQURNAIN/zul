...
from Kynan import pbot as app
from Kynan import arq
from Kynan.services.keyboard import Ikb
from Kynan.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from Kynan.services.tasks import _get_tasks_text, all_tasks, rm_task
from Kynan.services.types import InlineQueryResultCachedDocument
from Kynan.modules.info import get_chat_info, get_user_info
from Kynan.modules.music import download_youtube_audio
from Kynan.utils.functions import test_speedtest
from Kynan.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/7eff872759b4d8df175d8.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/Ling_Musik_Bot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Hʏᴘᴇʀ Aꜱꜱɪꜱᴛᴀɴᴛ🇮🇩](https://t.me/Ling_Musik_Bot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [˹zσɴкᴇʏ ᴅ ʟɪɴɢ˼](t.me/excute7)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
