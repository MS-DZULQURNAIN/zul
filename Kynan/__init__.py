...
def get_user_list(__init__, key):
    with open("{}/Kynan/{}".format(os.getcwd(), __init__), "r") as json_file:
...
LOGGER.info("Rito is starting. | An Rito Robot Parts. | Licensed under GPLv3.")
...
if ENV:
    ...
    JOIN_LOGGER = os.environ.get("JOIN_LOGGER", "-1001864253073")
    ...
    NEW_DIALOG_TIMEOUT = int(os.environ.get("NEW_DIALOG_TIMEOUT", "600"))
...
from Kynan.modules.helper_funcs.handlers import (
